...
export default function About(props) {
    return (
        <div className='container' style={{color: props.mode==='light'? 'white':'black',backgroundColor: props.mode==='dark'? '#042742':'white'}}>
            ...
            <div className="accordion" id="accordionExample">
                ...
                {/* <div className="container my-3">
                    <button type="button" onClick={toggleSytle} class="btn btn-primary">{btntext}</button>
                </div> */}
            </div>
        </div>
    )
